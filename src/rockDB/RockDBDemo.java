...
public class RockDBDemo {
	static{
		//System.out.println(System.getProperty("user.dir"));
		//RocksDB.loadLibrary();
		//System.load("D:/workspace2/mvnTest/src/rockDB/librocksdbjni-win64");
		System.load("C:/Users/humiao/AppData/Local/Temp/librocksdbjni1207575366638289306.dll");
	}

	public static void main(final String[] args) {
		final String db_path = "D:/rockDB";
		...
		try (final Options options = new Options();
			...
			try{
				options.setCreateIfMissing(true).setStatistics(stats).setWriteBufferSize(8 * SizeUnit.KB).setMaxWriteBufferNumber(3)
			...
			table_options.setBlockCacheSize(64 * SizeUnit.KB).setFilter(bloomFilter).setCacheNumShardBits(6).setBlockSizeDeviation(5)
					.setBlockRestartInterval(10).setCacheIndexAndFilterBlocks(true).setHashIndexAllowCollision(false)
